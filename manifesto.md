...
Every day we open a social media feed expecting to see _what matters_. But it only shows _what spreads_. It’s not evil. It’s just incentives: engagement is cheap, so it gets gamed.
...
But algorithms can’t tell the difference, because the signal is noisy.

## Root cause of the sloppening

Engagement has no skin in the game. There's no cost for engaging with slop, so selfish interests boost slop. And there's no reward for engaging with bangers, so curators don't boost bangers. Platforms prioritize posts by activity (instead of quality), because it’s what they can measure.
